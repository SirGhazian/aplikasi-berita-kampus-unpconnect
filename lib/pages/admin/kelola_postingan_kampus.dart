...
class KelolaPostinganKampus extends StatefulWidget {
  const KelolaPostinganKampus({super.key});

  @override
  State<KelolaPostinganKampus> createState() => _KelolaPostinganKampusState();
}

class _KelolaPostinganKampusState extends State<KelolaPostinganKampus> {
    ...
    showDialog(
      ...
      builder: (context) => AlertCard(
        ...
        onConfirm: () async {
          ...
          try {
            await FirestoreService().deletePost(postId, 'berita_kampus');
            if (mounted) {
          ...
          child: Column(
            ...
            children: [
              ...
              SearchFieldWithHeader(
                title: "Kelola Postingan Kampus",
                controller: _searchController,
              ),

              const SizedBox(height: 20),

              // TOMBOLEDIT POSTINGAN
              Padding(
              ...
              Padding(
                ...
                child: StreamBuilder<List<PostinganModel>>(
                  stream: FirestoreService().getBeritaKampus(),
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        const collectionName = 'berita_kampus';
